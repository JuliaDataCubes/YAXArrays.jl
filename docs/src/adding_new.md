...
## `mapslices` for data cubes



## Calling mapCube

It is possible for the user to apply their own functions or function from any Julia package on
arbitrary cube objects. Note that there will be no difference in performance compared to the
builtin functions, they will actually use the same machinery.
