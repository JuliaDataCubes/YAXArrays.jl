...
function InnerObj(dc::DATConfig)
  T1=(length.(getsmallax.(dc.incubes))...,)
  T2=(length.(getsmallax.(dc.outcubes))...,)
  inbroad = collect(Any,map(i->(i.loopinds...,),dc.incubes))
  outbroad= collect(Any,map(i->(i.loopinds...,),dc.outcubes))
