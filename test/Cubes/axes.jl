@testset "Axes" begin
    ...
    using Dates
    using YAXArrays.Cubes.Axes: axVal2Index, axVal2Index_lb, axVal2Index_ub, findAxis, axname, axsym, renameaxis
    ...
    (RangeAxis, "MonthTimeRange",Date(2001,1,1):Month(1):Date(2002,12,31),Day(30)),
    (RangeAxis, "DayTimeRange",DateTime(2002,1,1):Day(1):DateTime(2002,1,31),Hour(24)),
    ...
    @test getAxis(RangeAxis("FloatRange",1.0:-0.1:0.1),axlist) == RangeAxis("FloatRange",1.0:-0.1:0.1)
end
