...
@testset "YAXArrays" begin
    ...
    @testset "YAXArrayBase interface" begin
        ...
        a2 = YAXArrayBase.yaxcreate(YAXArray, reshape(1:27,3,3,3),["d1","d2","d3"],
            [1:3,["One","Two","Three"], 0.1:0.1:0.3], Dict("att"=>5))
    ...
    @testset "Subsets" begin
        ...
        @test YAXArrays.Cubes.interpretsubset((Date(2001,1,2),Date(2001,1,5)), tax) == 2:4
